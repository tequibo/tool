...
//  tool
//
//  Created by sasha t. on 17.10.2023.
//
...
class SharedObject: ObservableObject {
	@Published var data: String = "testing 1111"
	@Published var prompt: String = "rings"
	@Published var steps: Double = 50
	@Published var fpsExport: Double = 30
	@Published var fps: Int = 30
	@Published var angle: Float = Float.tau / 60
	@Published var offsetRatio: Double = 0.01
	@Published var loopTime: TimeInterval = TimeInterval(15)
	@Published var isConsoleVisible: Bool = false // Add this property
	@Published var output: String = "..." // Add this property
	@Published var knobs = [Int](repeating: 0, count: 9)
	@Published var faders = [Int](repeating: 0, count: 5)
...
struct EasingFunctions {
	static var easeInOutQuad: (Float) -> Float = { t in
		return t < 0.5 ? 2 * t * t : -1 + (4 - 2 * t) * t
	}
}
func map(value: CGFloat, fromLow: CGFloat, fromHigh: CGFloat, toLow: CGFloat, toHigh: CGFloat) -> CGFloat {
...
enum Knowlege {
    static let wordName:String = "RubberDough"
    static var coins = 100
	static let eyes = ["◕","─", "•","^","˘", "★","ʘ","▼","ಠ","°","*","＋","°","￢","˘","✦","꒡","◉","◐","◑","♥","ꈍ","❛","ಡ","•ิ"]
	static let mouths = ["∀","‿", "‸","ヮ"," ω ","﹏","ヘ","ε","^","ㅂ","､","ᴥ","▽","ڡ","ｪ","︵","╭╮","ᴗ"," □ ","～","."]
}
...
func resizeImage(image: CGImage, to newSize: CGSize) -> CGImage? {
